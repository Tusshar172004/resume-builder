      ...
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <a
              href="https://www.linkedin.com/in/tushar-patil-a51448227/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer">
              <Instagram width='20' height='20' className="hover:text-green-500"/>
            </a>
            <a
              href="https://github.com/Tusshar172004"
              target="_blank"
              rel="noreferrer"
            >
              <Github width='20' height='20' className="hover:text-green-500" />
            </a>
          </div>
